...
public class Parallax : MonoBehaviour
{
    ...
    void Update()
    {
    	Speed = ((parallaxCamera.velocity.x * Time.deltaTime) * 4) * -1;
    ...
    public void SetupPosition(Parallax p, Camera c, int index)
    {
        ...
        for (int i = 0; i < GameObjects.Count; i++)
        {
                ...
                RepositionLogic.PositionMode == ParallaxPositionMode.IndividualStartOnScreen)
            {
                ...
                {
                    x = (RepositionLogic.PositionMode == ParallaxPositionMode.IndividualStartOnScreen ? r.bounds.min.x : start + r.bounds.size.x);
                    y = (RepositionLogic.PositionMode == ParallaxPositionMode.IndividualStartOnScreen ? r.bounds.min.y : 0);
                }
